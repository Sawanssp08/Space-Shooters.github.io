...
function preload() {
  ...
  music = loadSound("Rock.mp3")
  space2Img=loadImage("space3.jpg")
}
...
space2=createSprite(1000,700,10,10);
space2.addImage(space2Img);
space2.scale=0.8

  space = createSprite(280,350,30,20);
...
function draw() {
  ...
  if(gameState === instruction) {
    ...
    text("ALL THE BEST",canvas.width/2-300,canvas.height/2+100);
    stroke("yellow");
    fill("yellow");
    textSize(35);
    ...
    text("  Help the people and the Earth !",canvas.width/2-300,canvas.height/2-130);
